...
port_forward(){
	# 设置端口转发
	sudo iptables -t nat -I PREROUTING -d $interfaceip -p tcp -m multiport ! --dports 22,10086,10000 -j DNAT --to-destination 10.0.0.2
	sudo iptables -t nat -I PREROUTING -d $interfaceip -p udp -m multiport ! --dports 22,10086,10000 -j DNAT --to-destination 10.0.0.2
